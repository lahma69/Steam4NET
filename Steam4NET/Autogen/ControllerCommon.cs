...
namespace Steam4NET
{
	...
	public enum EControllerSetting : int
	{
		...
		k_EControllerSettingTouch_menu_button_count = 71,
		k_EControllerSettingTouch_menu_opacity = 72,
		k_EControllerSettingTouch_menu_position_x = 73,
		k_EControllerSettingTouch_menu_position_y = 74,
		k_EControllerSettingTouch_menu_scale = 75,
		k_EControllerSettingMouse_dampening_trigger = 76,
		k_EControllerSettingMouse_trigger_clamp_amount = 77,
		k_EControllerSettingTouch_menu_show_labels = 78,
		k_EControllerSettingGyro_sensitivity_scale = 79,
		k_EControllerSettingScale = 80,
		k_EControllerSettingPosition_x = 81,
		k_EControllerSettingPosition_y = 82,
		k_EControllerSettingTeleport_start = 83,
		k_EControllerSettingTeleport_stop = 84,
		k_EControllerSettingTouchmenu_button_fire_type = 85,
		k_EControllerSettingTest_param_0 = 86,
		k_EControllerSettingTest_param_1 = 87,
		k_EControllerSettingTest_param_2 = 88,
		k_EControllerSettingTest_param_3 = 89,
		k_EControllerSettingTest_param_4 = 90,
		k_EControllerSettingTest_param_5 = 91,
		k_EControllerSettingTest_param_6 = 92,
		k_EControllerSettingTest_param_7 = 93,
		k_EControllerSettingTest_param_8 = 94,
		k_EControllerSettingTest_param_9 = 95,
		k_EControllerSettingAction_set_trigger_cursor_show = 96,
		k_EControllerSettingAction_set_trigger_cursor_hide = 97,
		k_EControllerSettingDelay_start = 98,
		k_EControllerSettingDelay_end = 99,
		k_EControllerSettingCycle = 100,
		k_EControllerSettingToggle = 101,
		k_EControllerSettingRepeat_rate = 102,
		k_EControllerSettingDouble_tap_time = 103,
		k_EControllerSettingLong_press_time = 104,
		k_EControllerSettingActivation_threshold = 105,
		k_EControllerSettingMouse_warp_x = 106,
		k_EControllerSettingMouse_warp_y = 107,
		k_EControllerSettingAnalog_value = 108,
		k_EControllerSettingInterruptable = 109,
		k_EControllerSettingSoft_press_sytle = 110,
		k_EControllerSettingActivator_output_axis = 111,
	};
